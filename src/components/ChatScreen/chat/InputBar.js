        ...
        return (
            ...
            >
                <View style={{flexDirection: 'row', alignItems: 'center', marginVertical: 8, paddingHorizontal: 10}}>
                    {
                        useVoice ? <View style={{height: 34, justifyContent: 'center', alignItems: 'center'}}
                                         activeOpacity={0.7}>
                    ...
                    <View style={{
                        ...
                        borderRadius: 18,
                        borderColor: '#ccc',
                        width: (width - 30 - 64 - 16 - (useVoice ? 30 : 0)),
                            ...
                            >
                                <View style={[{
                                    ...
                                    <Text style={{
                                        ...
                                        fontWeight: 'bold',
                                        color: '#555'
                                    }}>{isVoiceEnd ? `${pressOutText}` : `${pressInText}`}</Text>
                                </View>
                            </View>
                            : <TouchableOpacity
                                disabled={!enabled}
                            ...
                            >
                                <TextInput
                                    ...
                                    style={[styles.commentBar__input, {
                                        height: Math.max(35, inputChangeSize),
