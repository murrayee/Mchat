...
class sessionService {
   ...
   * @returns {Promise<void>}
   */
  saveMessageToLocal = async (key, params) => {
   ...
   */
  restoreMessageFromLocal = async (key, number = 0, size) => {
   ...
   * @returns {Promise<void>}
   */
  saveSessionToLocal = async (sessionListMap) => {
   ...
   * @returns {Promise<*>}
   */
  restoreSessionFromLocal = async (sessionListMap) => {
