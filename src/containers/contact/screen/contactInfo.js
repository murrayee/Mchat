        ...
        >
          <View style={contactInfoStyles.content}>
            ...
            <List>
              ...
              <Item extra={`${'murrayee@163.com'}`} arrow="horizontal">邮箱地址</Item>
            </List>
            <View style={contactInfoStyles.buttons}>
              <Button type="primary" onPress={() => {console.log('123');navigation.navigate('chat', { profile: profile })}}>发送消息</Button>
              <WhiteSpace/>
              <Button>视频聊天</Button>
            </View>
          </View>
